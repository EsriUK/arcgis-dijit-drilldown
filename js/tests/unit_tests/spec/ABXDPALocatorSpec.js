...
describe("A set of tests for the ABX DPA Locator", function () {
    var _ABXLocator, widget, server,
        testAttributes = {
            DPA_POST_TOWN: "test town", DPA_DEP_LOCALITY: "local", DPA_THOROUGHFARE: "High Street", ANOTHER_FIELD: "Uh oh", ADMINISTRATIVE_AREA: "",
        ...
        var results = {
            "candidates": [{
                ...
                "attributes": {
                    ...
                    "PAO_END_SUFFIX": "",
                    "PAO_TEXT": "",
                    "DPA_THOROUGHFARE": "MARYLEBONE HIGH STREET",
                    "DPA_DEP_LOCALITY": "",
                    "ADMINISTRATIVE_AREA": "CITY OF WESTMINSTER",
                    "DPA_POST_TOWN": "LONDON"
                }
            },{
