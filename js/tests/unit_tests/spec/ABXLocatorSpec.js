...
describe("A set of tests for the ABX Locator", function () {
    var _ABXLocator, widget, server,
        testAttributes = {
            TOWN_NAME: "test town", LOCALITY_NAME: "local", STREET_DESCRIPTION: "High Street", ANOTHER_FIELD: "Uh oh", ADMINISTRATIVE_AREA: "",
        ...
        loadWidget = function (done) {
            require(["app/Locators/ABXLocator"], function (ABXLocator) {
                widget = new ABXLocator("");
                _ABXLocator = ABXLocator;
    ...
    it("should be an ABX locator", function (done) {
        expect(widget.locatorType).toEqual("ABX");
    ...
    it("should populate a picklist", function (done) {
        widget._buildPickList(abxResults).then(function () {
        ...
        var results = {
            "candidates": [{
                ...
                "attributes": {
                    ...
                    "PAO_END_SUFFIX": "",
                    "PAO_TEXT": "",
                    "STREET_DESCRIPTION": "MARYLEBONE HIGH STREET",
                    "LOCALITY_NAME": "",
