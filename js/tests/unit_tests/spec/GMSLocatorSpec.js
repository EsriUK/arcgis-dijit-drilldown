...
describe("A set of tests for the GMS Locator", function () {
    var _GMSLocator, widget, server,
        testAttributes = {
            TOWN_NAME: "test town", LOCALITY_NAME: "local", STREET_NAME: "High Street", ANOTHER_FIELD: "Uh oh", COUNTY_NAME: "",
            PAO_START_NO: "4", PAO_END_NO: "", PAO_START_SFX: "A", PAO_END_SFX: "", PAO_TEXT: "",
            SAO_START_NO: "", SAO_END_NO: "3", SAO_START_SFX: "Z", SAO_END_SFX: "", SAO_TEXT: "bob"
        },
        loadWidget = function (done) {
            require(["app/Locators/GMSLocator"], function (GMSLocator) {
                widget = new GMSLocator("");
                _GMSLocator = GMSLocator;
    ...
    it("should be an GMS locator", function (done) {
        expect(widget.locatorType).toEqual("GMS");
    ...
    it("should populate a picklist", function (done) {
        widget._buildPickList(gmsResults).then(function () {
    ...
    it("should return the correct text for the PAO", function (done) {
        ...
        testAttrs.PAO_END_NO = "3";
        testAttrs.PAO_END_SFX = "B";
        testAttrs.PAO_START_NO = "1";
        testAttrs.PAO_START_SFX = "C";
    ...
    it("should return the correct text for the SAO", function (done) {
        ...
        testAttrs.SAO_END_NO = "3";
        testAttrs.SAO_END_SFX = "B";
        testAttrs.SAO_START_NO = "1";
        testAttrs.SAO_START_SFX = "C";
        ...
        var results = {
            "candidates": [{
                ...
                "attributes": {
                    ...
                    "PAO_END_SFX": "",
                    "PAO_TEXT": "",
                    "STREET_NAME": "MARYLEBONE HIGH STREET",
                    "LOCALITY_NAME": "",
                    "COUNTY_NAME": "CITY OF WESTMINSTER",
                    "TOWN_NAME": "LONDON"
                }
            },{
